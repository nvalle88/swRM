    ...
    public class MotivoAsientoController : Controller
    {
        ...
        public async Task<Response> PostMotivoAsiento([FromBody] MotivoAsiento motivoAsiento)
        {
            try
            {
                ...
                var respuesta = Existe(motivoAsiento);
