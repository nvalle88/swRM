...
namespace bd.swrm.web.Controllers.API
{
    ...
    public class CompaniaSeguroController : Controller
    {
        ...
        public Response Existe(CompaniaSeguro companiaSeguro)
        {
            var bdd = companiaSeguro.Nombre.ToUpper().TrimEnd().TrimStart();
            var loglevelrespuesta = db.CompaniaSeguro.Where(p => p.Nombre.ToUpper().TrimStart().TrimEnd() == bdd).FirstOrDefault();
